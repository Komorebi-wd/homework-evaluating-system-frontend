        ...
        <el-main style="display: flex">
          ...
          <el-scrollbar class="el-scrollbar" max-height="100vh" style="width: 700px;height: 100vh">
            ...
            <div class="scrollbar-demo-item">
              ...
              {{"作业有疑问"}}
              <el-button type="primary" @click="goToPage(cid,cname,'/addAppeal')" style="margin-left: auto" >提交申诉</el-button>
            </div>

            <div class="scrollbar-demo-item">
              <el-icon class="el-icon"><Document /></el-icon>
              {{"查看已回复申诉"}}
              <el-button type="primary" @click="goToPage(cid,cname,'/answeredAppeal')" style="margin-left: auto" >前往</el-button>
            </div>

            <div class="scrollbar-demo-item">
              <el-icon class="el-icon"><Document /></el-icon>
              {{"查看未回复申诉"}}
              <el-button type="primary" @click="goToPage(cid,cname,'/unAnsweredAppeal')" style="margin-left: auto" >前往</el-button>
            </div>

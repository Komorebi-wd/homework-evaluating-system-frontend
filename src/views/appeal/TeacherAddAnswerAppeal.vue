      ...
      <el-container>
        ...
        <el-main style="display: flex">
          ...
          <div class="container">
            ...
            />
            <div >
              <el-button type="primary" @click="submitAppeal">提交回复</el-button>
              <el-button type="success" @click="submitCancel">取消回复</el-button>
            </div>
          </div>
...
import {answerSuggestionWithSuggestionIdAnswer} from "@/net";
...
const textarea = ref('')
const suggestionId = ref(0);


onMounted(() => {
  suggestionId.value = router.currentRoute.value.query.suggestionId;

})

const submitAppeal = () => {
  answerSuggestionWithSuggestionIdAnswer(suggestionId.value,textarea.value)
      .then((data) => {
        console.log(data)

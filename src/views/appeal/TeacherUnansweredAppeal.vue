      ...
      <el-container>
        ...
        <el-main style="display:flex">
          ...
          <el-table :data="works"  v-loading="loading" stripe style="width: 100%">
            ...
            <!-- 教师号列 -->
            <el-table-column label="教师号" width="160">
              <template #default="scope">
            ...
            <!-- 申诉内容列 -->
            <el-table-column label="申诉内容" width="300">
              <template #default="scope">
            ...
            <!-- 回复列 -->
            <el-table-column label="处理申诉" width="180">
              <template #default="scope">
                <span>
                  <el-button type="primary" @click="goToPage(scope.row.suggestionId)">回复</el-button>
                </span>
              </template>
            </el-table-column>

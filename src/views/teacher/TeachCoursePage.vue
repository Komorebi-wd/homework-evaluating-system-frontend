          ...
          <el-scrollbar max-height="100vh" style="width: 700px;height: 100vh">
            ...
            <div class="scrollbar-demo-item" v-for="item in classes" :key="item.id">
              ...
              <div style="margin-left: auto">
                <el-button type="primary"   @click="goToPage(item.cid,item.cname,'/workManage')" >发布作业</el-button>
                <el-button type="success"   @click="goToPage(item.cid,item.cname,'/teacherAppeal')" >处理申诉</el-button>
              </div>
